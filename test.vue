  ...
  <div >
        <div style="font-size: 20px;width:13cm; margin-top: 0.5cm;border: 1px solid #000000; padding: 10px;height: 14cm ">
          <div style="">
            ...
            <div style="font-size: 22px;padding:15px 5px 15px 0"></div>
            <div>电话:</div>
            <div><span style="font-size: 22px;font-weight: bold;padding:15px 0"></span></div>
            <table>
...
<script>
  export default {
    ...
    methods: {
      ...
      send: function () {
        if (this.tempConfirm.jglx == '2' || this.tempConfirm.jglx == '4') {
          this.socket.send(document.getElementById("kd").innerHTML)
        } else {
          this.socket.send(document.getElementById("bkd").innerHTML)
        }
